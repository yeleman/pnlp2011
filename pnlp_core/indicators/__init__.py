...
INDICATOR_SECTIONS = \
    [{'id': '1', 'label': u"Identification de la structure ayant notifié les données", 'sections': {}},
    ...
    {'id': '5', 'label': u"Décès", \
          'sections': {'all': u"Tout âge confondu", \
                       ...
                       'over_five': u"5 ans et plus", \
                       'pregnant_women': u"Femmes enceintes"}},
    {'id': '6', 'label': u"Moustiquaires imprégnées  d’Insecticides de Longue Durée (MILD)", 'sections': {}},
    {'id': '7', 'label': u"Rupture de stock de CTA", 'sections': {}},
    {'id': '8', 'label': u"Rupture de stock des produits de PEC du paludisme grave", 'sections': {}},
    {'id': '9', 'label': u"Rupture de stock MILD, TDR, SP", 'sections': {}},
    {'id': '10', 'label': u"CPN et Traitement Préventif  Intermittent  (TPI)", 'sections': {}}]
