...
urlpatterns = patterns('',
    ...
    # ANTIM : Transmission
    url(r'^transmission/$', views.transmission.monitoring_transmission,
                            name='monitoring_transmission'),
    url(r'^log_message/$', views.transmission.log_message, name='log_message'),
    url(r'^report_unvalidated/$', views.transmission.report_unvalidated,
                                  name='report_unvalidated'),
    url(r'^send_message/$', views.transmission.send_message,
                            name='send_message'),
