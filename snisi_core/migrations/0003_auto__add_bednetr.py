...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'BednetR'
        db.create_table('snisi_core_bednetr', (
            ...
            ('period', self.gf('django.db.models.fields.related.ForeignKey')(related_name='snisi_core_bednetr_reports', to=orm['bolibana.Period'])),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='snisi_core_bednetr_reports', to=orm['bolibana.Entity'])),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='snisi_core_bednetr_reports', to=orm['bolibana.Provider'])),
            ...
            ('initial_mild', self.gf('django.db.models.fields.IntegerField')()),
            ('received_mild', self.gf('django.db.models.fields.IntegerField')()),
            ('distributed_mild', self.gf('django.db.models.fields.IntegerField')()),
            ('remaining_mild', self.gf('django.db.models.fields.IntegerField')()),
            ('difference_mild', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('snisi_core', ['BednetR'])

        # Adding M2M table for field sources on 'BednetR'
        db.create_table('snisi_core_bednetr_sources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_bednetr', models.ForeignKey(orm['snisi_core.bednetr'], null=False)),
            ('to_bednetr', models.ForeignKey(orm['snisi_core.bednetr'], null=False))
        ))
        db.create_unique('snisi_core_bednetr_sources', ['from_bednetr_id', 'to_bednetr_id'])


    def backwards(self, orm):
        
        # Deleting model 'BednetR'
        db.delete_table('snisi_core_bednetr')

        # Removing M2M table for field sources on 'BednetR'
        db.delete_table('snisi_core_bednetr_sources')
    ...
    models = {
        ...
        'snisi_core.bednetr': {
            'Meta': {'object_name': 'BednetR'},
            '_status': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'snisi_core_bednetr_reports'", 'to': "orm['bolibana.Provider']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'difference_mild': ('django.db.models.fields.IntegerField', [], {}),
            'distributed_mild': ('django.db.models.fields.IntegerField', [], {}),
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'snisi_core_bednetr_reports'", 'to': "orm['bolibana.Entity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_mild': ('django.db.models.fields.IntegerField', [], {}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['bolibana.Provider']", 'null': 'True', 'blank': 'True'}),
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'period': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'snisi_core_bednetr_reports'", 'to': "orm['bolibana.Period']"}),
            'receipt': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '30', 'blank': 'True'}),
            'received_mild': ('django.db.models.fields.IntegerField', [], {}),
            'remaining_mild': ('django.db.models.fields.IntegerField', [], {}),
            'sources': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'sources_rel_+'", 'null': 'True', 'to': "orm['snisi_core.BednetR']"}),
            'type': ('django.db.models.fields.PositiveIntegerField', [], {})
        },
