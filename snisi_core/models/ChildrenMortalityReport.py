...
class AggregatedChildrenMortalityReport(Report):
    ...
    sexe_female = models.IntegerField()

    age_under_1w = models.IntegerField()
    age_under_2weeks = models.IntegerField()
    age_under_1month = models.IntegerField()
    age_under_3month = models.IntegerField()
    age_under_6month = models.IntegerField()
    age_under_9month = models.IntegerField()
    age_under_1 = models.IntegerField()
    age_under_2 = models.IntegerField()
    age_under_3 = models.IntegerField()
    age_under_4 = models.IntegerField()
    age_under_5 = models.IntegerField()

    death_home = models.IntegerField()
    death_center = models.IntegerField()
    death_other = models.IntegerField()

    cause_death_fever = models.IntegerField()
    cause_death_diarrhea = models.IntegerField()
    cause_death_dyspnea = models.IntegerField()
    cause_death_anemia = models.IntegerField()
    cause_death_rash = models.IntegerField()
    cause_death_cough = models.IntegerField()
    cause_death_vomiting = models.IntegerField()
    cause_death_nuchal_rigidity = models.IntegerField()
    cause_death_red_eye = models.IntegerField()
    cause_death_eat_refusal = models.IntegerField()
    cause_death_other = models.IntegerField()
